...
import 'package:yoga_the_daily_fitness/model/model.dart';
import 'package:yoga_the_daily_fitness/services/localdb.dart';
import 'package:yoga_the_daily_fitness/services/yogadb.dart';
  ...
  checkUp() async{
    await LocalDB.getFirstTime().then((value) async {
      ...
      if(value.toString() == "null" || value != false) {
        ...
        // CREATING ONE YOGA WORKOUT PACK
        makeYogaSumEntry(YogaSummary(YogaWorkOutName: YogaModel.YogaTable2, BackImg: "assets/01_Suryanamskar/main.jpg", TimeTaken: "6", TotalNoOfWork: "12", yogakey: 2));
makeYogaEntry(Yoga(Seconds: true, YogaImgUrl: "assets/01_Suryanamskar/12.png", YogaKey_WorkOuts: 2, YogaTitle: "kuhinasan ovam", SecondsOrTimes: '15'), YogaModel.YogaTable2);
